...
| **자격증명 저장** | Credentials Provider | CMWallet (Credential Provider) | Crypto Wallet |
...
| **관련 에이전트** | 4개 (Shopping, Merchant, Credentials, Payment) | 4개 (Shopping, Merchant, CMWallet*, Payment**) | 3개 (Shopping, Merchant, Credentials) + Blockchain |
